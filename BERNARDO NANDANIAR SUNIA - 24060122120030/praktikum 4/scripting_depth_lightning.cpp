...
{ 
    ...
    glVertex3f(-3.0f, -3.0f, -3.0f); // Kiri bawah
    glVertex3f(3.0f, -3.0f, -3.0f); // Kanan bawah
    glVertex3f(3.0f, -3.0f, 3.0f); // Kanan atas
    glVertex3f(-3.0f, -3.0f, 3.0f); // Kiri atas
    glEnd(); 
    ...
    glVertex3f(-3.0f, -3.0f, -3.0f); // Kiri bawah
    glVertex3f(0.0f, 3.0f, 0.0f); // Atas
    glVertex3f(3.0f, -3.0f, -3.0f); // Kanan bawah
    glEnd(); 
